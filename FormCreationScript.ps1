...
function mouseDown { 
    ...
    $Global:MouseCurFirstX = ([System.Windows.Forms.Cursor]::Position.X ) 
    $Global:MouseCurFirstY = ([System.Windows.Forms.Cursor]::Position.Y ) 
 
} 

function mouseMove ($mControlName) { 
 
    $MouseCurMoveX = ([System.Windows.Forms.Cursor]::Position.X ) 
    $MouseCurMoveY = ([System.Windows.Forms.Cursor]::Position.Y ) 
 
    if ($Global:MouseCurFirstX -ne 0 -and $Global:mCurFirstY -ne 0){ 
      
        $mDifX = $Global:MouseCurFirstX - $MouseCurMoveX  
        $mDifY = $Global:MouseCurFirstY - $MouseCurMoveY  
          
        $this.Left = $this.Left - $mDifX 
        $this.Top = $this.Top - $mDifY  
 
        $Global:MouseCurFirstX = $MouseCurMoveX  
        $Global:MouseCurFirstY = $MouseCurMoveY  
...
function mouseUP ($mControlObj) { 
    ...
    $MouseCurUpX = ([System.Windows.Forms.Cursor]::Position.X ) 
    $MouseCurUpY = ([System.Windows.Forms.Cursor]::Position.Y ) 
 
    $Global:MouseCurFirstX = 0 
    $Global:MouseCurFirstY = 0 
 
 
    Foreach ($MouseElement In $Global:MouseFormObj.Elements){ 
 
        if ($MouseElement.Name -eq $this.name){ 
